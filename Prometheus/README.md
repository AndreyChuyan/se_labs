...
^
| 3 000 ┤                                ●   редкие очень медленные запросы
|       |
| 2 000 ┤                         ●  ← самые медленные 5% запросов
|       |
| 1 000 ┤              ●   ●
|       |
|   300 ┼──────────────┬──────────────────────── P95 = 300 ms
|       |              |
|   100 ┤      ●  ● ●  |   здесь 95% запросов быстрее 300 ms
|       |   ● ● ● ● ●  |
|     0 └─────────────────────────────────────────────────→ Requests (запросы)
          0%        50%            95%                100%
...
Расшифровка:
- Вертикальная ось — задержка ответа в миллисекундах.
- Горизонтальная ось — все запросы, отсортированные от самых быстрых (слева) к самым медленным (справа).
- Вертикальная линия на 300 ms — это P95:  
  95% точек (запросов) **слева** от неё, их задержка ≤ 300 ms.  
  Оставшиеся 5% **справа** — могут быть до 2–3 секунд и дольше.
